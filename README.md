...
|------|-----------------|------------------|---------------|--------|
| 🧑‍💻 | **Mario García Luque** | [mgarluq1102@g.educaand.es](mailto:mgarluq1102@g.educaand.es) | **Tech Lead · Backend & Security Architect**<br/>• **Backend Supabase**: Diseño de base de datos (34 tablas), migraciones SQL versionadas, Row Level Security (RLS) y Custom Access Token Hooks (JWT claims).<br/>• **Edge Functions**: Desarrollo de funciones serverless (`invoice-pdf` facturas, `subscription-email` Resend, `qr-sign` firmas QR y `ai-chat` IA).<br/>• **Seguridad & CI/CD**: Cookies híbridas, sanitización XSS, auditoría OWASP ZAP y despliegues automáticos (Vercel/Supabase). | [@Mariogarluu](https://github.com/Mariogarluu) |
| 🧑‍💻 | **Salvador Bueno González** | [sbuegon0702@g.educaand.es](mailto:sbuegon0702@g.educaand.es) | **Frontend UI/UX Designer · Frontend Developer**<br/>• **Angular**: Maquetación y consistencia visual de vistas, dashboard interactivo, sistema dinámico de Temas (Claro/Oscuro), i18n global multiidioma (ES, EN, FR) y componentes compartidos (Navbar, Footer, selectors).<br/>• **Backend**: Migraciones de usuarios legacy (CUID-a-UUID) e Iban para facturación. | [@sbuegonz00](https://github.com/sbuegonz00) |
