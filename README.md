...
|------|-----------------|------------------|---------------|--------|
| 🧑‍💻 | **Mario García Luque** | [mgarluq1102@g.educaand.es](mailto:mgarluq1102@g.educaand.es) | **Tech Lead · Backend & Security Architect**<br/>• **Backend Supabase**: Diseño de base de datos (34 tablas), migraciones SQL versionadas, RLS y Custom Access Token Hooks (JWT claims).<br/>• **Edge Functions**: Desarrollo de funciones serverless (`invoice-pdf` facturas, `subscription-email` Resend, `qr-sign` firmas QR y `ai-chat` IA).<br/>• **Seguridad & CI/CD**: Cookies híbridas, sanitización XSS, auditoría OWASP ZAP y despliegues (Vercel/Supabase).<br/>• **App Android (Kotlin)**: Conexión de Android a Supabase, inyección segura de secretos (local.properties + BuildConfig), firmas QR y hardening de release. | [@Mariogarluu](https://github.com/Mariogarluu) |
| 🧑‍💻 | **Salvador Bueno González** | [sbuegon0702@g.educaand.es](mailto:sbuegon0702@g.educaand.es) | **Frontend UI/UX Designer · Frontend Developer**<br/>• **Angular UI/UX**: Maquetación responsive, consistencia visual y sistema dinámico de Temas (Claro/Oscuro).<br/>• **Angular Core & i18n**: Dashboard interactivo, internacionalización global (ES, EN, FR) y componentes compartidos (Navbar, Footer).<br/>• **Backend**: Migraciones de usuarios legacy (CUID-a-UUID) e Iban para facturación.<br/>• **App Android (Kotlin)**: Base de datos local (Room) para entrenamientos/dietas, notificaciones, pantalla de entrenamiento activo y refactorización de repositorios. | [@sbuegonz00](https://github.com/sbuegonz00) |
| 🧑‍💻 | **Samuel García Ruiz** | [sgarrui1201@g.educaand.es](mailto:sgarrui1201@g.educaand.es) | **Jira & CRUD Master · Full-Stack Developer**<br/>• **Jira**: Gestión del backlog, sprints, historias de usuario e informes de progreso.<br/>• **Frontend Angular**: Panel analítico en tiempo real de Superadmin (Chart.js), CRUDs core (centros, máquinas, clases), rediseño estético premium de suscripciones, i18n dinámica e integración de NgZone.<br/>• **Analítica BI**: Script ETL de extracción de datos (Python Pandas) y diseño del Dashboard de Power BI Premium para Superadmin.<br/>• **App Android (Kotlin)**: Desarrollador principal (CámaraX, MediaStore, persistencia local DataStore, refactorización a PostgREST y consumo de Edge Functions). | [@sgarrui1201](https://github.com/sgarrui1201) |
